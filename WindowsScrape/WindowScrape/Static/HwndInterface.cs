namespace WindowScrape.Static
{
    ...
    internal static class HwndInterface
    {
        ...
        [DllImport("user32.dll")]
        private static extern bool GetWindowModuleFileName(IntPtr hWnd, StringBuilder lpszFileName, uint cchFileNameMax);

        public static string GetWindowFileName(IntPtr hWnd)
        {
            uint filenamesize = 1000;
            StringBuilder filename = new StringBuilder((int)filenamesize);
            GetWindowModuleFileName(hWnd, filename, filenamesize);
